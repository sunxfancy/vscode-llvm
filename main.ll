...
$"??_C@_0P@DOOKNNID@Hello?0?5world?$CB?6?$AA@" = comdat any

@"??_C@_0P@DOOKNNID@Hello?0?5world?$CB?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [15 x i8] c"Hello, world!\0A\00", comdat, align 1
...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) #0 {
  ...
  %6 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_0P@DOOKNNID@Hello?0?5world?$CB?6?$AA@")
  ret i32 0
}
